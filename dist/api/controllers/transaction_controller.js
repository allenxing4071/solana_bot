...
exports.getTransactionStats = exports.getRecentTransactions = exports.getTransactionById = exports.getTransactions = void 0;
...
const getTransactionStats = async (req, res) => {
    try {
        ...
        const averageProfit = successTransactions.length > 0
            ...
            : 0;
        // 找出最大利润交易
        const maxProfitTx = successTransactions.reduce((max, tx) => Number(tx.profit) > Number(max.profit) ? tx : max, { profit: '0' });
        // 构建统计数据
        const stats = {
        ...
        logger_1.default.error('获取交易统计信息失败', MODULE_NAME, {
            error: error instanceof Error ? error.message : String(error)
        });
        res.status(500).json({
            success: false,
