...
async function measureRpcLatency(endpoint) {
    ...
    try {
        // 创建连接
        const connection = new web3_js_1.Connection(endpoint.url);
        // 测试1: 获取最新区块高度
        ...
        const testWallet = new web3_js_1.PublicKey('So11111111111111111111111111111111111111112'); // SOL代币地址
        ...
        await axios_1.default.post(endpoint.url, { jsonrpc: '2.0', id: 1, method: 'getHealth' });
...
//# sourceMappingURL=test_latency.js.map